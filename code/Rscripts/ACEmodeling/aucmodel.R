...
twinData <-read.xlsx("RDMin1.xlsx", sheetIndex = 1, na.strings = "NA")
head(twinData)
# remove bad data
twinData = subset(twinData, twinData$twinsNum != c("T001", "T028"))
...
# Set Starting Values
svMe      <- .6                       # start value for means
svVa      <- .007                        # start value for variance
